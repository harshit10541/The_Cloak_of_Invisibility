...
def main():
    ...
    # range of colours that we want to go invisible
    ...
    while True:
        ...
        mask = create_mask(frame, lower_blue, upper_blue) #applying mask through create_mask function
        result = apply_cloak_effect(frame, mask, background) #cloak effect applied to blue colour

        cv2.imshow("Invisble Cloak", result)
